...
At this point the generated data cube includes the following dimensions:
...
This mapping is embedded in the WA+ `print_sheet` Python module, (example for [Sheet 1](https://github.com/wateraccounting/WAPORWA/blob/master/modules/WA/sheet1.py) in the WAPORWA repo). Importantly many SVG elements are **fields calculated** from output variables. We might need to replicate that logic as part of the ETL process[^fn2].
