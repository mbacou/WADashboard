...
Using a dependency graph to show water allocation between agriculture and non-ag uses (or other breakdowns).

```{r, out.width="40%", fig.show='hold'}
plot_wheel(iso3="ken", subset="period=='year' & year==2003",
  title="System Water Uses",
  subtitle="2003")

plot_wheel(iso3="ken", subset="period=='year' & year==2017",
  title="System Water Uses",
  subtitle="2017")
```
...
Using a dependency graph to show ET allocation across land use categories.
