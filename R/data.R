...
#'
#' A data cube of WA+ hydrological time-series generated by [data_etl]. Field codes
#' are documented in [META].
#'
#' @keywords datasets
#' @name DATA
...
#' Variable catalog
#'
#' A data.table of variable metadata (measure and dimension codes).
#'
#' @keywords datasets
#' @name META
#' @format A data.table with columns:
